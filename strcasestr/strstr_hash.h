...
int mseed;
static  char *single_nhash(char *s,int slen,char *n,int nlen){int i;
  long nhash=0;
  long shash=0;
...
static char *double_nhash(char *s,int slen,char *n,int nlen){int i;
  long nhash1=0;
  long shash1=0;
  long nhash2=0;
  long shash2=0;
...
static __attribute__ ((noinline)) char *strstr_hash(char *s,int slen,char *n,int nlen){int i;
